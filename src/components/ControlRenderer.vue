<template>
  <div v-if="control" class="control-renderer">
    ...
    <!-- Number -->
    <div v-else-if="control.type === 'number'" class="control-widget number-widget">
      <input 
        type="number" 
        :value="control.value" 
        :min="control.min" 
    ...
    <!-- Checkbox -->
    <div v-else-if="control.type === 'checkbox'" class="control-widget checkbox-widget">
    ...
    <!-- Color -->
    <div v-else-if="control.type === 'color'" class="control-widget color-widget">
    ...
    <!-- Dropdown -->
    <div v-else-if="control.type === 'dropdown'" class="control-widget dropdown-widget">
      <select 
        :value="control.value" 
        class="select-input"
        @mousedown.stop
      ...
      >
        <option v-for="(option, idx) in control.options" :key="idx" :value="option">{{ option }}</option>
      </select>
    </div>
  </div>
  <div v-else class="control-error">
    Control not found
  </div>
</template>
...
function onChange(value: any) {
    // Basic type conversion if needed based on input type
    let val = value;
